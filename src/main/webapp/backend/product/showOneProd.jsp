...
<body>
	...
	<a
		href="${pageContext.request.contextPath}/backend/product/showAllProd.jsp">Back
		to List</a>

	<form method="post"
		action="${pageContext.request.contextPath}/backend/prod.do"
		enctype="multipart/form-data">
		<input type="hidden" name="action" value="updateOne" /> <input
			type="hidden" name="prod_no" value="${oneProd.product_no}" />
		<table border=1>

			<tr>
				<td>Product Name:</td>
				<td><input type="text" name="prod_name" class="input"
					value="${oneProd.prod_name}"></td>
			</tr>
			<tr>
				<td>Product Introduce :</td>
				<td><textarea name="prod_introduce" class="input" cols="50"
						rows="4">${oneProd.prod_introduce}
	</textarea></td>
			</tr>
			<tr>
				<td>Product Price :</td>
				<td><input type="text" name="prod_price" class="input"
					value="${oneProd.prod_price}"></td>
			</tr>
			<tr>
				<td>Product Stock :</td>
				<td><input type="text" name="prod_stock" class="input"
					value="${oneProd.prod_stock}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="file" class="input" name="prod_pic"
					id="prod_pic" onchange="previewImage()" /> <img id="blob_holder"
					width='300'
					src="${pageContext.request.contextPath}/reader/DBGifReader?product_no=${oneProd.product_no}"></td>
			</tr>
		</table>

		<br> <input type="submit" value="update" /> <a
			href="${pageContext.request.contextPath}/backend/index.jsp">Back
			to Home</a>
	</form>
