...
<table border=1>
	...
	<td>
	<textarea name="prod_introduce" class="input" cols="50" rows="4">${oneProd.prod_introduce}
	</textarea>
	</td>
	</tr>
	<tr>
	...
	<option value="${cat.category_no}" ${(oneProd.category_no==cat.category_no)? 'selected':'' }>${cat.category_name}</option>
	</c:forEach>
	</select>
	</td>
	</tr>
